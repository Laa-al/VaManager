...
public class ModPathFilter: ViewModelBase, IFilterDescriptor<ModDescriptor>
{
    ...
    {
        return item.ModPath.Contains(FilterValue, StringComparison.InvariantCultureIgnoreCase);
    }

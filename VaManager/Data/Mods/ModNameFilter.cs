...
public class ModNameFilter : ViewModelBase, IFilterDescriptor<ModDescriptor>
{
    ...
    {
        return item.PackageName.Contains(FilterValue, StringComparison.InvariantCultureIgnoreCase);
    }
